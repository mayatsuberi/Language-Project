#!/bin/bash
#SBATCH --job-name=embed_he
#SBATCH --mail-user=yahlizamero@gmail.com
#SBATCH --mail-type=BEGIN
#SBATCH --mail-type=END
#SBATCH --mail-type=FAIL
#SBATCH --output=/sci/labs/arielgoldstein/yahlizamero/Language-Project/jobs/logs/02_he_%j.txt
...
echo "=== Notebook 02: Hebrew Embeddings === $(date)"
jupyter nbconvert --to notebook --execute \
    --ExecutePreprocessor.timeout=7200 \
    --output notebooks/02_Generate_Embeddings_HE_executed.ipynb \
    notebooks/02_Generate_Embeddings_HE.ipynb
echo "Done: $(date)"
