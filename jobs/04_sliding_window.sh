#!/bin/bash
#SBATCH --job-name=sliding_win
#SBATCH --mail-user=yahlizamero@gmail.com
#SBATCH --mail-type=BEGIN
#SBATCH --mail-type=END
#SBATCH --mail-type=FAIL
#SBATCH --output=/sci/labs/arielgoldstein/yahlizamero/Language-Project/jobs/logs/04_sliding_%j.txt
...
echo "=== Notebook 04: Sliding Window === $(date)"
jupyter nbconvert --to notebook --execute \
    --ExecutePreprocessor.timeout=10800 \
    --output notebooks/04_Generate_Sliding_Window_Embeddings_executed.ipynb \
    notebooks/04_Generate_Sliding_Window_Embeddings.ipynb
echo "Done: $(date)"
